          ...
          <div className="hidden sm:flex sm:justify-center sm:flex-1 sm:ml-20">
            ...
            {navigation.map((item) => (
              item.href ? (
                ...
                <button
                  key={item.name}
                    className="group inline-flex items-center px-4 py-2 text-sm font-medium text-gray-700 hover:text-blue-600 hover:bg-gray-50 rounded-md transition-all duration-200 ease-in-out"
                  aria-label={item.name}
                >
                  <item.icon
          ...
          <div className="pt-4 pb-3 space-y-2 px-4">
            {navigation.map((item) => (
              item.href ? (
                ...
                <button
                  key={item.name}
                  className="group w-full flex items-center px-4 py-3 text-base font-medium text-gray-700 hover:text-blue-600 hover:bg-gray-50 rounded-md transition-all duration-200 ease-in-out"
                  aria-label={item.name}
                >
                  <item.icon
                    className="mr-4 h-6 w-6 text-gray-400 group-hover:text-blue-500"
                    aria-hidden="true"
                  />
                  <span className="font-semibold">{item.name}</span>
                </button>
